...
1. **禁止违法使用**：您同意不以任何违反中华人民共和国法律法规及您所在地区法律的方式使用本软件。
2. **闭源与专有**：本软件是一个闭源项目，所有版权归作者 eguid 所有。
3. **个人免费授权**：本软件仅允许为个人、非商业目的下载、安装和使用。
4. **完整许可**：使用本软件即表示您同意 [LICENSE](./LICENSE) 文件中的所有条款。

```
自由无线投屏（FreeWirelessCast） 最终用户许可协议

版权所有 (c) 2026 eguid。保留所有权利。

1. 许可授予
版权持有人授予您一项非排他性、不可转让、可撤销的个人许可，仅允许您为个人、非商业目的下载、安装和使用 自由无线投屏（FreeWirelessCast） 软件（以下简称“软件”）。
