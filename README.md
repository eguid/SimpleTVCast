...
3. 修复网友反馈的win11、win7操作系统下桌面镜像投屏报错：创建桌面视频流失败问题。

中期计划：
1. 支持摄像头麦克风投屏。
2. 支持麦克风音频投送到智能音箱。
3. 支持从NAS、树莓派等第三方和嵌入式设备的远程媒体投屏到电视。

远期计划
1. 完善桌面投屏，支持系统声音采集。
2. 推出自由无线投屏-FreeWirelessCast的安卓手机端应用作为pc端的联动遥控器或者单独作为投屏工具。
3. 推出自由无线投屏-FreeWirelessCast的投屏微信小程序，作为pc端的联动遥控器或者单独作为投屏工具。
