...
## 遇到的困难
1.0版本推出后遇到了很多问题，很多bug，很多网友表示根本用不了，一度比较棘手，之前博主也只是业余时间自娱自乐，开发了一个自己玩玩，没想到会有这么多人使用。
那么这次花了两、三周时间把软件重新梳理了一遍，解决了UPnP/DLNA协议底层的问题，之前的第三方库了问题太多实在不可控，于是直接花了几天时间重新实现了底层协议交互。诸如此类还有多网卡的问题，ssdp占用问题，投屏视频卡的转圈圈的问题，视频不清晰的问题，中文字符不支持的问题等等，一个接着一个问题，这次2.0.0版本全部都一次性给全部解决了。
